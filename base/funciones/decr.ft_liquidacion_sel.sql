...
monto_total from obingresos.tdeposito td
    ...
    ***********************************/
        ...
        /*********************************
     #TRANSACCION:  'DECR_CONCEPTOS_SEL'
     #DESCRIPCION:    Consulta de datos
     #AUTOR:        Favio Figueroa
     #FECHA:        17-04-2020 01:54:37
    ***********************************/

    elsif(p_transaccion='DECR_CONCEPTOS_SEL')then
        ...
        /*********************************
         #TRANSACCION:  'DECR_CONCEPTOS_CONT'
         #DESCRIPCION:    Conteo de registros
         #AUTOR:        Favio Figueroa
         #FECHA:        17-04-2020 01:54:37
        ***********************************/

    elsif(p_transaccion='DECR_CONCEPTOS_CONT')then
